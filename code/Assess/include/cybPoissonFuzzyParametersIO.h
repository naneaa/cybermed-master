...
#ifndef _CYBPOISSONFUZZYPARAMETERSIO_H_
#define _CYBPOISSONFUZZYPARAMETERSIO_H_

class CybPoissonFuzzyParametersIO : public CybAssessIO
{
public:
	
	CybPoissonFuzzyParametersIO(const char*);
...
#endif /*_CYBPOISSONFUZZYPARAMETERSIO_H_*/
