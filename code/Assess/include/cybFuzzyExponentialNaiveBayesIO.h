...
#ifndef _CYBFuzzyExponentialNaiveBayesIO_H_
#define _CYBFuzzyExponentialNaiveBayesIO_H_

class CybFuzzyExponentialNaiveBayesIO : public CybAssessIO
{
public:
	
	CybFuzzyExponentialNaiveBayesIO(const char*);
...
#endif /*_CYBFuzzyExponentialNaiveBayesIO_H_*/
