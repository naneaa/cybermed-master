...
#define SPACE typename mfBinaryIO<_Traits>::space
#define IDS typename mfBinaryIO<_Traits>::ids

template <class _Traits> class mfBinaryIO
{
public:
...
template <class _Traits> mfBinaryIO<_Traits>::mfBinaryIO()
{
}
...
template <class _Traits> void mfBinaryIO<_Traits>::idsStore(ofstream &fp, ids num)
{
	unsigned char flag;
	unsigned char f = 0;
...
template <class _Traits> IDS mfBinaryIO<_Traits>::idsLoad(ifstream &fp)
{
	ids num;
...
template <class _Traits> void mfBinaryIO<_Traits>::spaceStore(ofstream &fp, space num)
{
	ids aprox;
...
template <class _Traits> SPACE mfBinaryIO<_Traits>::spaceLoad(ifstream &fp)
{
	space num;
	ids aprox;
	unsigned char flag;
