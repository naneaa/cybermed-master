#ifndef MFMESHNOSURFACE_H
#define MFMESHNOSURFACE_H
 ...
 */
template <class _Traits> class mfMeshNOSurface : public mfMeshOper<_Traits>
{
public:
...
template <class _Traits> mfMeshNOSurface<_Traits>::mfMeshNOSurface(sMesh *_mesh)
: mfMeshOper<_Traits>(_mesh)
{
}

template <class _Traits> mfMeshNOSurface<_Traits>::~mfMeshNOSurface()
{
}

template <class _Traits> void mfMeshNOSurface<_Traits>::addCell(ids idcell, ids *idvertices MF_DMUTEXV)
{
...
template <class _Traits> void mfMeshNOSurface<_Traits>::delCell(ids idcell MF_DMUTEXV)
{

}

template <class _Traits> void mfMeshNOSurface<_Traits>::searchFace(int idcell, int idvertex)
{
	MF_ASSERT(this->mesh->getVertex(idvertex)->getNumberOfSings());
	mfVertexStarIteratorTriSurf<_Traits> ic(this->mesh);
	mfList<ids> lista;
...
template <class _Traits> int mfMeshNOSurface<_Traits>::sameVertices(int idcell1, int idcell2, int iq[])
{
	int i, j, v1, v2, nv = 0;
...
template <class _Traits> bool mfMeshNOSurface<_Traits>::setMate(int idcell, int idcellmate, int iq[])
{
	for(int i=0; i<3; i++)
	{
...
template <class _Traits> void mfMeshNOSurface<_Traits>::searchSings(int idvertex)
{
	mfList<ids> lista;
	mfList<ids> flags;
