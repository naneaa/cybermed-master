...
#define IDS typename mfMesh3D<_Traits>::ids
#define SVERTEX typename mfMesh3D<_Traits>::sVertex
#define SCELL typename mfMesh3D<_Traits>::sCell
#define SEDGE typename mfMesh3D<_Traits>::sEdge
#define SFACE typename mfMesh3D<_Traits>::sFace
 ...
 *	@date		2007, july
 */
template <class _Traits> class mfMesh3D
{
public:
	...
	typedef typename _Traits::sEdge sEdge;		/**< Edge typename definition */
        typedef typename _Traits::sEdge sFace;		/**< Edge typename definition */
 ...
 private:
	...
	mfVector<sFace,ids> faces;		/**< Vector of the mesh's faces */
...
template <class _Traits> mfMesh3D<_Traits>::mfMesh3D(ids block_size):
...
template <class _Traits> mfMesh3D<_Traits>::~mfMesh3D()
{
#ifdef MF_THREADS
...
template <class _Traits> IDS mfMesh3D<_Traits>::getBlockSize()
{
	return bsize;
}
...
template <class _Traits> IDS mfMesh3D<_Traits>::addVertex(space *coords MF_DMUTEXV)
{
	ids idvertex;
...
template <class _Traits> void mfMesh3D<_Traits>::addVertex(ids idvertex, space *coords MF_DMUTEXV)
{
	sVertex* v;
...
template <class _Traits> bool mfMesh3D<_Traits>::delVertex(ids idvertex MF_DMUTEXV)
{
...
template <class _Traits> IDS mfMesh3D<_Traits>::getNumberOfVertices(MF_DMUTEX)
{
	MF_LOCK(vertices_mutex);
...
template <class _Traits> void mfMesh3D<_Traits>::setNumberOfVertices(ids number MF_DMUTEXV)
{
	MF_LOCK(vertices_mutex);
...
template <class _Traits> IDS mfMesh3D<_Traits>::getVertexMaxId(MF_DMUTEX)
{
	MF_LOCK(vertices_mutex);
...
template <class _Traits> SVERTEX* mfMesh3D<_Traits>::getVertex(ids idvertex MF_DMUTEXV)
{
	MF_ASSERT(idvertex >= 0);
	return &vertices[idvertex];
}

template <class _Traits> bool mfMesh3D<_Traits>::isVertex(ids idvertex MF_DMUTEXV)
{
...
template <class _Traits> IDS mfMesh3D<_Traits>::addCell(ids *idvertices MF_DMUTEXV)
{
...
template <class _Traits> void mfMesh3D<_Traits>::addCell(ids idcell, ids *idvertices MF_DMUTEXV)
{
	MF_ASSERT(idvertices);
...
template <class _Traits> bool mfMesh3D<_Traits>::delCell(ids idcell MF_DMUTEXV)
{
...
template <class _Traits>  IDS mfMesh3D<_Traits>::getNumberOfCells(MF_DMUTEX)
{
	MF_LOCK(cells_mutex);
...
template <class _Traits> void mfMesh3D<_Traits>::setNumberOfCells(ids number MF_DMUTEXV)
{
	MF_LOCK(cells_mutex);
...
template <class _Traits> IDS mfMesh3D<_Traits>::getCellMaxId(MF_DMUTEX)
{
	MF_LOCK(vertices_mutex);
...
template <class _Traits>  SCELL* mfMesh3D<_Traits>::getCell(ids idcell MF_DMUTEXV)
{
	MF_ASSERT(idcell >= 0);
	return &cells[idcell];
}

template <class _Traits> bool mfMesh3D<_Traits>::isCell(ids idcell MF_DMUTEXV)
{
	return cells[idcell].inMesh(MF_MUTEX);
}

template <class _Traits> IDS mfMesh3D<_Traits>::addCell(ids *idvertices, ids *idops MF_DMUTEXV)
{
	ids idcell;
...
template <class _Traits> IDS mfMesh3D<_Traits>::addEdge()
{
	ids idedge;
...
template <class _Traits> IDS mfMesh3D<_Traits>::getNumberOfEdges(MF_DMUTEX)
{
	MF_LOCK(edges_mutex);
...
template <class _Traits> IDS mfMesh3D<_Traits>::getEdgeMaxId(MF_DMUTEX)
{
	MF_LOCK(edges_mutex);
...
template <class _Traits> SEDGE* mfMesh3D<_Traits>::getEdge(ids idEdge MF_DMUTEXV)
{
	MF_ASSERT(idEdge >= 0);
	return &edges[idEdge];
}

template <class _Traits> bool mfMesh3D<_Traits>::isEdge(ids idEdge MF_DMUTEXV)
{
...
template <class _Traits> void mfMesh3D<_Traits>::freeCell(ids idcell MF_DMUTEXVD)
{
	MF_LOCK(cells_mutex);
...
template <class _Traits> void mfMesh3D<_Traits>::freeVertex(ids idvertex MF_DMUTEXVD)
{
	MF_LOCK(vertices_mutex);
...
template <class _Traits> void mfMesh3D<_Traits>::freeEdge(ids idedge MF_DMUTEXVD)
{
	MF_LOCK(edges_mutex);
