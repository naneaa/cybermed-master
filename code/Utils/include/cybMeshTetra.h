#ifndef CYBMESHTETRA_H
#define CYBMESHTETRA_H

#include "mf/mfMeshTetra.h"
 ...
 *	@date		2007, july
 */
template <class _Traits> class cybMeshTetra : public mfMeshTetra<_Traits>
{
public:
...
template <class _Traits> cybMeshTetra<_Traits>::cybMeshTetra(sMesh *_mesh)
: mfMeshTetra<_Traits>(_mesh)
{
	geom.setMesh(_mesh);
}

template <class _Traits> cybMeshTetra<_Traits>::~cybMeshTetra()
{
}

template <class _Traits> void cybMeshTetra<_Traits>::addCell(ids idcell, ids *idvertices MF_DMUTEXV)
{
...
template <class _Traits> void cybMeshTetra<_Traits>::delCell(ids idcell MF_DMUTEXV)
{
}

template <class _Traits> void cybMeshTetra<_Traits>::searchFace(int idcell, int idvertex)
{
...
template <class _Traits> int cybMeshTetra<_Traits>::sameVertices(int idcell1, int idcell2, int iq[])
{
	int i, j, v1, v2, nv = 0;
...
template <class _Traits> bool cybMeshTetra<_Traits>::setMate(int idcell, int idcellmate, int iq[])
{
	int temp;
	for(int i=0; i<4; i++)
	{
...
template <class _Traits> void cybMeshTetra<_Traits>::searchSings(int idvertex)
{
	mfList<ids> lista;
	mfList<ids> flags;
...
template <class _Traits> void cybMeshTetra<_Traits>::lockVertices(ids *idv, sVertex** v)
{
	ids ordem[4];
	int temp,i,j;
...
template <class _Traits> void cybMeshTetra<_Traits>::unlockVertices(ids *idv, sVertex** v)
{
	ids ordem[4];
	int temp,i,j;
