...
/**
@class		ofCellsIterator 
@file		ofCellsIterator.h 
@short
	Iterator for cells
...
public:
	 ...
	 * 
	 * @param ids init the cell we want to start (default zero)
...
private:
	...
	ids iatu, iinit;		/**< the cell address and the init cell */
	sCell *atu;				/**< pointer to cell */
